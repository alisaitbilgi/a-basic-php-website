...
<div class="container">
	...
	<div class="sidebar">
		<p id="side_p">FILTER OPTIONS</p>
		<form class="form" action="filter.php" method="POST" autocomplete="off">
			...
			<button style="margin-top:40px" name="add" type="submit" class="buton" value="add">FILTER</button>
		</form>
	</div>
	<div class="content">
